...
if(isset($_POST['submit']))
  {
    ...
    $emp1wd=$_POST['emp1workduration'];
     ...
     $query=mysqli_query($con, "insert into empexpireince ( EmpID,Employer1Name, Employer1Designation, Employer1CTC) value('$eid','$emp1name', '$emp1des', '$emp1ctc', '$emp1wd')");
    if ($query) {
